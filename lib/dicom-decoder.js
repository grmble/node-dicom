...
DicomDecoder.prototype.decodeDataElement = function (callback) {
    var w16u = this.endianess.getUInt16, w32u = this.endianess.getUInt32, buffers = [], group, element, tag, vrStr, dataElement, bytes, length;
    ...
    this.request(2, parsebuffer.setter(buffers, function () {
        ...
        dataElement = new this.endianess[vrStr]();
        dataElement.tag = tag;
        bytes = dataElement.valueLengthBytes(this.implicit);
