...
DICOM.VR.prototype.niceStr = function () {
    var s = "vr:" + this.vr;
    if (typeof this.tag !== 'undefined)') {
        s += " tag:" + this.tag.toString(16);
    }
    if (typeof this.rawValue !== 'undefined)') {
        s += " value: " + this.rawValue;
        /*
        this.decode(this.rawValue).forEach(function(x) {
            s += toString(x);
            s += "\\";
        });
        */
