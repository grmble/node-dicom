...
var util = require('util')
    ...
    , ENDIAN_VRS = ['UL', 'OW', 'OF']
    , NON_ENDIAN_VRS = ['OB', 'SQ', 'UN', 'UT', 'UI', 'SH', 'CS', 'DA', 'TM'
                            , 'LO', 'ST', 'PN']
    , SIX_BYTE_VRS = ['OB', 'OW', 'OF', 'SQ', 'UN', 'UT']
...
/**
 *
 * endianess specific fake node-binary methods
 */

exports.LE = {}
exports.LE.word16u = function () {
    return this.word16lu.apply(this, arguments)
}
exports.LE.word32u = function () {
    return this.word32lu.apply(this, arguments)
}

exports.BE = {}
exports.BE.word16u = function () {
    return this.word16bu.apply(this, arguments)
}
exports.BE.word32u = function () {
    return this.word32bu.apply(this, arguments)
}
 ...
 *
 *
 * VR instances are reusable, so we create them once for each
 * endianess and are done with it.
 */
;[].concat(ENDIAN_VRS, NON_ENDIAN_VRS).forEach(function (klassName) {
    exports.LE[klassName] = new DICOM.LE[klassName]()
    exports.BE[klassName] = new DICOM.BE[klassName]()
})
